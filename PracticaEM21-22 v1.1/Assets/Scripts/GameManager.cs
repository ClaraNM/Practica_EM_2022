...
public class GameManager : NetworkBehaviour
{
   ...
   public NetworkVariable<bool> canStart = new NetworkVariable<bool>();
    ...
    private void Awake()
    {
        ...
        uiManager.OnFinishGame.AddListener(FinishGameOnServerRpc);
    }
    ...
    private void OnDestroy()
    {
        ...
        uiManager.OnFinishGame.RemoveListener(FinishGameOnServerRpc);
    ...
    [ServerRpc]
    private void FinishGameOnServerRpc()
    {
        
        if (player.Deaths.Value == currentPlayers.Value - 1)
        {
            FinishGameOnClientRpc();
        }
