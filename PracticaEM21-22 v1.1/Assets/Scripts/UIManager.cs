...
public class UIManager : MonoBehaviour
{
  ...
  //  [SerializeField] private Button buttonHost;
    ...
    [Header("Game Over Local")]
    [SerializeField] private GameObject gameOverLocal;

    [Header("Game Over Global")]
    [SerializeField] private GameObject gameOver;
    [SerializeField] private Button buttonExitGameOver;
    ...
    private void Start()
    {
       ...
       // buttonClient.onClick.AddListener(() => StartSelectorPlayer());
        ...
        //Botones que aparecen una vez termina la partida
        buttonExitGameOver.onClick.AddListener(() => DisconectClient());
        buttonRestart.onClick.AddListener(() => StartClient());
    ...
    public void ActivateGameOverLocal()
    {
        mainMenu.SetActive(false);
        inGameHUD.SetActive(false);
        SelectorTypeHUD.SetActive(false);
